...
use FluentCrm\Framework\Validator\Rules\In;
use FluentCrm\Framework\Validator\Rules\NotIn;
use FluentCrm\Framework\Validator\Rules\Unique;
use FluentCrm\Framework\Validator\Rules\Exists;
use FluentCrm\Framework\Validator\Rules\RequiredIf;
use FluentCrm\Framework\Validator\Rules\Dimensions;
use FluentCrm\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentCrm\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentCrm\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentCrm\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \FluentCrm\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentCrm\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \FluentCrm\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentCrm\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentCrm\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentCrm\Framework\Validator\Rules\Unique
     */
