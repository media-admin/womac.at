...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Model| \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentCrm\Framework\Database\Orm\Model|\FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
