...
use FluentCrm\Framework\Database\Orm\Casts\Attribute;
use FluentCrm\Framework\Database\Orm\Castable;
use FluentCrm\Framework\Database\Orm\Casts\AsCollection;
use FluentCrm\Framework\Database\Orm\Casts\AsArrayObject;
use FluentCrm\Framework\Database\Orm\Relations\Relation;
use FluentCrm\Framework\Database\Orm\InvalidCastException;
use FluentCrm\Framework\Database\Orm\JsonEncodingException;
use FluentCrm\Framework\Database\LazyLoadingViolationException;
use FluentCrm\Framework\Database\Orm\CastsInboundAttributes;
use FluentCrm\Framework\Support\Collection as BaseCollection;
use FluentCrm\Framework\Database\Orm\MissingAttributeException;
...
trait HasAttributes
{
     ...
     *
     * @var \FluentCrm\Framework\Encryption\Encrypter
     */
     ...
     * @return null
     *
     * @throws \FluentCrm\Framework\Database\Orm\MissingAttributeException
     */
     ...
     *
     * @param  \FluentCrm\Framework\Encryption\Encrypter  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \FluentCrm\Framework\Database\Orm\InvalidCastException
     */
