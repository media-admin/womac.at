...
use FluentCrm\Framework\Database\UniqueConstraintViolationException;
use FluentCrm\Framework\Database\Orm\Relations\Concerns\InteractsWithDictionary;
use FluentCrm\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\FluentCrm\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \FluentCrm\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentCrm\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\FluentCrm\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     *
     * @param  \FluentCrm\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \FluentCrm\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  int|null  $page
     * @return \FluentCrm\Framework\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentCrm\Framework\Pagination\Paginator
     */
     ...
     * @return \FluentCrm\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \FluentCrm\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \FluentCrm\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \FluentCrm\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \FluentCrm\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \FluentCrm\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentCrm\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\FluentCrm\Framework\Database\Query\Expression  $column
     * @return string|\FluentCrm\Framework\Database\Query\Expression
     */
