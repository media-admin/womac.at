...
abstract class BaseGrammar
{
     ...
     *
     * @param  \FluentCrm\Framework\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Query\Expression|string|int|float  $expression
