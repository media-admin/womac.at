...
use FluentCrm\Framework\Database\MultipleRecordsFoundException;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\FluentCrm\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \FluentCrm\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Query\Builder|\FluentCrm\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \FluentCrm\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentCrm\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentCrm\Framework\Pagination\CursorPaginator
     */
