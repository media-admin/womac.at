...
use FluentCrm\Framework\Database\RecordsNotFoundException;
use FluentCrm\Framework\Database\Orm\Relations\Relation;
use FluentCrm\Framework\Database\Orm\Relations\BelongsToMany;
use FluentCrm\Framework\Database\Orm\RelationNotFoundException;
use FluentCrm\Framework\Database\Orm\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \FluentCrm\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentCrm\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentCrm\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentCrm\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \FluentCrm\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentCrm\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentCrm\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentCrm\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentCrm\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Model|\FluentCrm\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCrm\Framework\Database\Orm\Model|\FluentCrm\Framework\Database\Orm\Collection|static|static[]
     *
     ...
     * @return TModel|TValue|\FluentCrm\Framework\Database\Orm\Collection
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Model
     *
     * @throws \FluentCrm\Framework\Database\Orm\ModelNotFoundException
     ...
     * @return mixed
     *
     * @throws \FluentCrm\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentCrm\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string  $name
     * @return \FluentCrm\Framework\Database\Orm\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentCrm\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\FluentCrm\Framework\Database\Query\Expression  $columns
     * @return array
     */
